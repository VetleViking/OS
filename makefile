...
# compileDoom: compileBoot
# 	i386-elf-gcc -c src/games/doom/doomgeneric/build/doomgeneric.o -o src/doomgeneric.c -std=gnu99 -ffreestanding -O2 -w -I include
